...
// healthcheck package. Consumers that don't need Prometheus can use the
// core healthcheck types without pulling in this dependency.
package metrics
...
// HealthCheckResult mirrors the core healthcheck.HealthCheckResult fields
// needed for metrics recording, avoiding a direct dependency on the parent package.
...
// RecordCircuitBreakerState records the circuit breaker state metric.
