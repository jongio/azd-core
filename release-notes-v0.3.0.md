# azd-core v0.3.0 - Test Infrastructure and CLI Output Release
...
Building on the success of v0.2.0's 6 utility packages, v0.3.0 focuses on two critical developer experience areas:
...
```bash
go get github.com/jongio/azd-core/testutil@v0.3.0
```
...
#### Step 1: Add Dependency
```bash
go get github.com/jongio/azd-core/cliout@v0.3.0
```
...
```bash
# Get latest version
go get github.com/jongio/azd-core@v0.3.0
...
- **API Documentation**: https://pkg.go.dev/github.com/jongio/azd-core@v0.3.0
